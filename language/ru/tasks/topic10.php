...
$tasks = [
    ...
    [
        'question' => 'Сколько решений имеет система:
        \[
        \begin{cases}
        2x + 4y = 8 \\
        x + 2y = 4
        \end{cases}
        \]',
        'options' => ['Одно решение', 'Нет решений', 'Бесконечно много решений', 'Два решения'],
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Системы линейных уравнений</title>
