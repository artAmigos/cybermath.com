...
$tasks = [
    [
        'question' => 'Как записать ½ в виде десятичной дроби?',
        'options' => ['0.2', '0.5', '0.25', '0.75'],
        'answer' => '0.5'
    ],
    [
        'question' => 'Какая из дробей является неправильной?',
        'options' => ['1/2', '3/4', '5/4', '2/3'],
        'answer' => '5/4'
    ],
    [
        'question' => 'Как записать 0.75 в виде обыкновенной дроби?',
    ...
    [
        'question' => 'Как записать 2.5 в виде смешанной дроби?',
        'options' => ['2¼', '2½', '2¾', '5/2'],
        'answer' => '2½'
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Десятичные и обыкновенные дроби</title>
