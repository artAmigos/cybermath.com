...
$tasks = [
    ...
    [
        'question' => 'Какое число является квадратным корнем из 64?',
        'options' => [6, 7, 8, 9],
        'answer' => 8
    ],
    [
    ...
    [
        'question' => 'Чему равно ∛125?',
        'options' => [3, 4, 5, 6],
        'answer' => 5
    ],
    [
        'question' => 'Упростите выражение: (2²)³',
        'options' => [8, 16, 32, 64],
        'answer' => 64
    ],
    [
        'question' => 'Какое из этих чисел является полным квадратом?',
        'options' => [18, 24, 36, 45],
        'answer' => 36
    ]
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Степени и корни</title>
