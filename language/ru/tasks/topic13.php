...
$tasks = [
    [
        'question' => 'Какое значение принимает функция f(x) = 2x + 3 при x = 4?',
        'options' => [8, 10, 11, 12],
        'answer' => 11
    ],
    [
        'question' => 'Какая из следующих записей является функцией?',
        'options' => ['y² = x', 'y = 3x - 2', 'x + y = 5', 'y = ±√x'],
        'answer' => 'y = 3x - 2'
    ],
    [
        'question' => 'Чему равно значение переменной a в уравнении 3a - 7 = 11?',
        'options' => [4, 5, 6, 7],
        'answer' => 6
    ],
    [
        'question' => 'Какая функция соответствует следующему описанию: "Функция, график которой является прямой"?',
        'options' => ['Квадратичная', 'Линейная', 'Показательная', 'Логарифмическая'],
        'answer' => 'Линейная'
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Переменная и функция</title>
