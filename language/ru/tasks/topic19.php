...
$tasks = [
    ...
    [
        'question' => 'Площадь прямоугольника со сторонами 4 см и 7 см равна:',
        'options' => [11, 22, 28, 44],
        'answer' => 28
    ],
    [
        'question' => 'Если периметр квадрата 20 м, то его площадь равна:',
        'options' => [16, 25, 36, 49],
        'answer' => 25
    ],
    [
        'question' => 'Периметр треугольника со сторонами 3 см, 4 см и 5 см равен:',
        'options' => [8, 10, 12, 15],
        'answer' => 12
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Площадь и периметр</title>
