...
$tasks = [
    [
        'question' => 'Решите неравенство: \( 3x - 5 > 4 \)',
        'options' => ['x > 3', 'x < 3', 'x > -3', 'x < -3'],
        'answer' => 'x > 3'
    ],
    [
        'question' => 'Какое неравенство соответствует промежутку \( (-\infty; -2] \)?',
        'options' => ['x ≤ -2', 'x ≥ -2', 'x < -2', 'x > -2'],
        'answer' => 'x ≤ -2'
    ],
    [
        'question' => 'Решите неравенство: \( -2x + 4 ≥ 8 \)',
        'options' => ['x ≤ -2', 'x ≥ -2', 'x ≤ 2', 'x ≥ 2'],
        'answer' => 'x ≤ -2'
    ],
    [
        'question' => 'Какое из следующих неравенств не имеет решений?',
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Неравенства</title>
