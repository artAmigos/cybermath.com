...
$tasks = [
    [
        'question' => 'Число √2 является...',
        'options' => ['Натуральным', 'Целым', 'Рациональным', 'Иррациональным'],
        'answer' => 'Иррациональным'
    ],
    [
        'question' => 'Число -3 это...',
        'options' => ['Натуральное', 'Иррациональное', 'Целое', 'Ничего из этого'],
        'answer' => 'Целое'
    ],
    [
        'question' => '0,5 — это...',
        'options' => ['Рациональное число', 'Натуральное число', 'Целое число', 'Иррациональное число'],
...
<body class="container py-5">
    <h1 class="mb-4 text-center">🧠 Типы чисел</h1>
            ...
            <div class="mb-4 p-4 task-card">
                ...
                <?php if ($show_result): ?>
                    ...
                    <?php elseif ($user_answers[$index] != $task['answer']): ?>
                        <div class="mt-2 text-danger">❌ Неверно. Правильный ответ: <strong><?= $task['answer'] ?></strong></div>
                    <?php else: ?>
                        <div class="mt-2 text-success">✅ Верно!</div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        <?php endforeach; ?>
