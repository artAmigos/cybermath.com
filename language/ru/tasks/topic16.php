...
$tasks = [
    ...
    [
        'question' => 'Какие координаты у точки, симметричной точке (4, 5) относительно оси X?',
        'options' => ['(4, -5)', '(-4, 5)', '(-4, -5)', '(5, 4)'],
        'answer' => '(4, -5)'
    ],
    [
        'question' => 'Чему равно расстояние между точками (1, 2) и (4, 6)?',
        'options' => [3, 4, 5, 6],
        'answer' => 5
    ],
    [
        'question' => 'Какая из точек лежит на оси Y?',
        'options' => ['(0, 3)', '(2, 0)', '(1, 1)', '(0, 0)'],
        'answer' => '(0, 3)'
    ],
    [
        'question' => 'Если точка находится во II четверти, какие знаки имеют её координаты?',
        'options' => ['(+, +)', '(-, +)', '(-, -)', '(+, -)'],
        'answer' => '(-, +)'
    ],
    [
        'question' => 'Где находится начало координат?',
        'options' => ['В центре плоскости', 'В I четверти', 'На пересечении осей X и Y', 'И 1, и 3 верны'],
        'answer' => 'И 1, и 3 верны'
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Координатная плоскость</title>
