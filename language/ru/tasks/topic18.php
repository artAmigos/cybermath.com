...
$tasks = [
    [
        ...
        'options' => ['Прямоугольник', 'Ромб', 'Квадрат', 'Параллелограмм'],
        'answer' => 'Квадрат'
    ],
    [
    ...
    [
        'question' => 'Какая фигура не является плоской?',
        'options' => ['Круг', 'Треугольник', 'Квадрат', 'Шар'],
        'answer' => 'Шар'
    ],
    [
        'question' => 'Как называется фигура, у которой три стороны?',
        'options' => ['Квадрат', 'Прямоугольник', 'Треугольник', 'Ромб'],
        'answer' => 'Треугольник'
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Геометрические фигуры</title>
