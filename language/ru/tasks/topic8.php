...
$tasks = [
    ...
    [
        'question' => 'Вычислите: log₅5 + log₅25',
        'options' => [2, 3, 4, 5],
        'answer' => 3
    ],
    [
        'question' => 'Какое из выражений равно log₃9?',
        'options' => ['1', '2', '3', '9'],
        'answer' => '2'
    ],
    [
        'question' => 'Чему равно ln(e⁵)?',
        'options' => ['1', 'e', '5', 'e⁵'],
        'answer' => '5'
    ],
    [
        'question' => 'Упростите выражение: log₃27 - log₃3',
        'options' => ['1', '2', '3', '9'],
        'answer' => '2'
    ],
    [
        'question' => 'Если logₓ16 = 2, то чему равно x?',
        'options' => [2, 4, 8, 16],
        'answer' => 4
    ]
];
