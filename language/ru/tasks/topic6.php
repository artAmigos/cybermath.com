...
$tasks = [
    [
        'question' => 'Какое число будет следующим в арифметической прогрессии: 7, 10, 13, ...?',
        'options' => [15, 16, 17, 18],
        'answer' => 16
    ],
    [
        'question' => 'Найдите 5-й член геометрической прогрессии, если b₁=3 и q=2',
        'options' => [24, 36, 48, 96],
        'answer' => 48
    ],
    [
        'question' => 'Чему равна сумма первых 4 членов арифметической прогрессии: 5, 8, 11, 14?',
        'options' => [36, 38, 40, 42],
        'answer' => 38
    ],
    [
    ...
    [
        'question' => 'Найдите разность арифметической прогрессии, если a₁=10, a₅=22',
        'options' => [2, 3, 4, 5],
        'answer' => 3
    ]
];
