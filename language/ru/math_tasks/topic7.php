...
$tasks = [
    ...
    2 => [
        'question' => "Вычислите: √49",
        'answer' => "7"
    ],
    3 => [
        'question' => "Чему равно (3^2) + (4^2)?",
        'answer' => "25"
    ],
    4 => [
        'question' => "Найдите корень из 121.",
        'answer' => "11"
    ],
    5 => [
    ...
    6 => [
        'question' => "Найдите значение выражения: √(81) + 2^4",
        'answer' => "25"
    ],
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Степени и корни - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📘 Степени и корни</h1>
