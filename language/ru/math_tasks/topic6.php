...
$tasks = [
    1 => [
        'question' => "Найдите 10-й член арифметической прогрессии, если первый член равен 3, а разность прогрессии равна 4.",
        'answer' => "39"
    ],
    2 => [
        'question' => "В геометрической прогрессии первый член равен 2, а знаменатель прогрессии равен 3. Чему равен 5-й член прогрессии?",
        'answer' => "162"
    ],
    3 => [
        'question' => "Сумма первых 5 членов арифметической прогрессии равна 75. Если первый член равен 5, найдите разность прогрессии.",
        'answer' => "7"
    ],
    4 => [
        'question' => "Чему равна сумма первых 4 членов геометрической прогрессии с первым членом 1 и знаменателем 2?",
        'answer' => "15"
    ],
    5 => [
        'question' => "Найдите разность арифметической прогрессии, если её третий член равен 11, а седьмой — 23.",
        'answer' => "3"
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Арифметическая и геометрическая прогрессия - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📘 Арифметическая и геометрическая прогрессия</h1>
