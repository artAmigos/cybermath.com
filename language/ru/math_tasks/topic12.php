...
$tasks = [
    1 => [
        'question' => "Какое из чисел больше: 7 или 9?",
        'answer' => "9"
    ],
    2 => [
        'question' => "Какое число меньше: -3 или 2?",
        'answer' => "-3"
    ],
    3 => [
        'question' => "Если x = 4 и y = 6, какое из значений больше: x или y?",
        'answer' => "y"
    ],
    4 => [
        'question' => "Реши неравенство: 5x < 20. Какое наибольшее целое значение может принимать x?",
        'answer' => "3"
    ],
    5 => [
        'question' => "Какое из следующих утверждений верно: 8 > 10, 10 > 8, 8 = 10?",
        'answer' => "10 > 8"
    ],
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Неравенства - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📏 Неравенства</h1>
