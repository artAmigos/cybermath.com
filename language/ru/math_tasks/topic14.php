...
$tasks = [
    1 => [
        'question' => "Построить график функции: y = x^2 + 2x + 1",
        'answer' => "График — парабола, с вершиной в точке (-1, 0)"
    ],
    2 => [
        'question' => "Построить график функции: y = sin(x)",
        'answer' => "График — синусоида"
    ],
    3 => [
        'question' => "Построить график функции: y = cos(x)",
        'answer' => "График — косинусоида"
    ],
    4 => [
        'question' => "Построить график функции: y = |x|",
        'answer' => "График — V-образная линия"
    ],
    5 => [
        'question' => "Построить график функции: y = e^x",
        'answer' => "График — экспонента"
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Графики функций - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📊 Графики функций</h1>
