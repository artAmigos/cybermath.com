...
$tasks = [
    1 => [
        'question' => "Скидка на товар составляет 20%. Если исходная цена — 1000 рублей, какова цена со скидкой?",
        'answer' => "800"
    ],
    2 => [
        'question' => "Ученику удалось правильно решить 75% из 20 заданий. Сколько заданий он решил верно?",
        'answer' => "15"
    ],
    3 => [
        'question' => "В классе 40 учеников. 25% из них — отличники. Сколько отличников в классе?",
        'answer' => "10"
    ],
    4 => [
        'question' => "Книга стоила 1200 рублей, но подорожала на 10%. Сколько она теперь стоит?",
        'answer' => "1320"
    ],
    5 => [
        'question' => "Цена товара снижена на 15%. Если новая цена — 1700 рублей, какова была старая цена?",
        'answer' => "2000"
    ],
    6 => [
        'question' => "Мальчик пробежал 60% дистанции в 3 км. Сколько километров он пробежал?",
        'answer' => "1.8"
    ],
    7 => [
        'question' => "На экзамене ученик набрал 90% из 50 возможных баллов. Сколько баллов он получил?",
        'answer' => "45"
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Проценты - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📊 Проценты</h1>
