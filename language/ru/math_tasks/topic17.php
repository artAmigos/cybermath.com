...
$topic_id = 17;  // Тема "Теорема Пифагора"

$tasks = [
    1 => [
        'question' => "Найти гипотенузу прямоугольного треугольника, если катеты равны 3 и 4.",
        'answer' => "5"
    ],
    2 => [
        'question' => "Гипотенуза прямоугольного треугольника равна 13, один из катетов равен 5. Найдите второй катет.",
        'answer' => "12"
    ],
    3 => [
        'question' => "В прямоугольном треугольнике один катет равен 8, а гипотенуза 10. Найдите второй катет.",
        'answer' => "6"
    ],
    4 => [
        'question' => "Найдите гипотенузу прямоугольного треугольника, если катеты равны 9 и 12.",
        'answer' => "15"
    ],
    5 => [
        'question' => "В прямоугольном треугольнике один катет равен 7, а гипотенуза 25. Найдите второй катет.",
        'answer' => "24"
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Теорема Пифагора - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧩 Теорема Пифагора</h1>
