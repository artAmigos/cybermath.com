...
$tasks = [
    1 => [
        'question' => "Переменная - это контейнер для хранения данных. Как называется тип данных, который может хранить только одно из двух значений?",
        'answer' => "логический"
    ],
    2 => [
        'question' => "Что такое функция в программировании?",
        'answer' => "фрагмент кода, который выполняет определенную задачу"
    ],
    3 => [
        'question' => "Какая из следующих переменных является числовой переменной? int, str, bool",
        'answer' => "int"
    ],
    4 => [
        'question' => "Какой результат выполнения следующего кода: x = 5, x = x + 3?",
        'answer' => "8"
    ],
    5 => [
        'question' => "Что происходит, когда переменная объявляется, но ей не присвоено значение?",
        'answer' => "переменная содержит значение по умолчанию"
    ],
    6 => [
        'question' => "Что такое аргумент функции?",
        'answer' => "значение, передаваемое функции при её вызове"
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Переменные и функции - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧩 Переменная и функция</h1>
