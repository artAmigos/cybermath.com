...
$tasks = [
    1 => [
        'question' => "Рассчитайте площадь прямоугольника, если его длина 12 см, а ширина 5 см.",
        'answer' => "60"
    ],
    2 => [
        'question' => "Найдите периметр квадрата, если его сторона 8 см.",
        'answer' => "32"
    ],
    3 => [
        'question' => "Площадь круга с радиусом 7 см.",
        'answer' => "153.94"
    ],
    4 => [
        'question' => "Периметр прямоугольного треугольника с катетами 6 см и 8 см.",
        'answer' => "24"
    ],
    5 => [
        'question' => "Найдите площадь треугольника с основанием 10 см и высотой 4 см.",
        'answer' => "20"
    ],
    6 => [
        'question' => "Периметр прямоугольника с длиной 15 см и шириной 10 см.",
        'answer' => "50"
    ],
    7 => [
        'question' => "Площадь параллелограмма с основанием 9 см и высотой 6 см.",
        'answer' => "54"
    ],
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Площадь и периметр - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧩 Площадь и периметр</h1>
