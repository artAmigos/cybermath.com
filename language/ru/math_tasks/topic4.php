...
$tasks = [
    1 => [
        'question' => "Преобразуйте обыкновенную дробь 3/4 в десятичную.",
        'answer' => "0.75"
    ],
    2 => [
        'question' => "Преобразуйте десятичную дробь 0.6 в обыкновенную несократимую дробь.",
        'answer' => "3/5"
    ],
    3 => [
        'question' => "Сложите дроби: 1/2 + 1/4 (ответ дайте в виде несократимой дроби).",
        'answer' => "3/4"
    ],
    4 => [
        'question' => "Вычтите дроби: 5/6 - 1/3 (ответ дайте в виде несократимой дроби).",
        'answer' => "1/2"
    ],
    5 => [
        'question' => "Умножьте дроби: 2/3 × 3/5 (ответ дайте в виде несократимой дроби).",
        'answer' => "2/5"
    ],
    6 => [
        'question' => "Разделите дроби: 3/4 ÷ 2/5 (ответ дайте в виде несократимой дроби).",
        'answer' => "15/8"
    ],
    7 => [
        'question' => "Сравните дроби: 3/7 и 5/9. Какая дробь больше? (ответ в формате 'a/b > c/d' или 'a/b < c/d')",
        'answer' => "5/9 > 3/7"
    ],
    8 => [
        'question' => "Преобразуйте смешанное число 2 1/3 в неправильную дробь.",
        'answer' => "7/3"
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Задачи: Дроби - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">½ Десятичные и обыкновенные дроби</h1>
