...
$tasks = [
    [
        'question' => 'Mis on ruudu ümbermõõt, kui selle külg on 6 cm?',
        'options' => [12, 18, 24, 36],
        'answer' => 24
    ],
    [
        'question' => 'Ristküliku pindala külgedega 4 cm ja 7 cm on:',
        'options' => [11, 22, 28, 44],
        'answer' => 28
    ],
    [
        'question' => 'Kui ruudu ümbermõõt on 20 m, siis selle pindala on:',
        'options' => [16, 25, 36, 49],
        'answer' => 25
    ],
    [
        'question' => 'Kolmnurga ümbermõõt külgedega 3 cm, 4 cm ja 5 cm on:',
        'options' => [8, 10, 12, 15],
        'answer' => 12
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Pindala ja ümbermõõt</title>
