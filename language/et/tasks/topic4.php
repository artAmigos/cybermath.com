...
$tasks = [
    [
        'question' => 'Kuidas kirjutada ½ kümnendmurdina?',
        'options' => ['0.2', '0.5', '0.25', '0.75'],
        'answer' => '0.5'
    ],
    [
        'question' => 'Milline murd on vale?',
        'options' => ['1/2', '3/4', '5/4', '2/3'],
        'answer' => '5/4'
    ],
    [
        'question' => 'Kuidas kirjutada 0.75 murdude kujul?',
        'options' => ['1/4', '1/2', '3/4', '2/5'],
        'answer' => '3/4'
    ],
    [
        'question' => 'Kui palju on ¼ + ½?',
        'options' => ['1/4', '1/2', '3/4', '1'],
        'answer' => '3/4'
    ],
    [
        'question' => 'Kuidas kirjutada 2.5 segamurduna?',
        'options' => ['2¼', '2½', '2¾', '5/2'],
        'answer' => '2½'
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($score === count($tasks)) {
        // Kontrollige, kas kasutaja on seda teemat varem läbinud
        ...
        if ($already_completed == 0) {
            // Arvestame teema läbituks (triger ise annab 50 münte)
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Kümnendmurdud ja tavalised murdud</title>
...
<body class="container py-5">
    <h1 class="mb-4 text-center">🧠 Kümnendmurdud ja tavalised murdud</h1>

    <?php if ($show_result): ?>
        <div class="alert alert-info animated-alert text-center fs-5">
            Õigesti vastasite <?= $score ?> / <?= count($tasks) ?> ülesandele!
