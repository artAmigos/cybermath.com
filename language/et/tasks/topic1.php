...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($score === count($tasks)) {
        // Kontrollige, kas kasutaja on juba seda teemat läbinud
        ...
        if ($already_completed == 0) {
            // Teema läbimise arvestamine (triger annab automaatselt 50 münti)
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Liitmine ja lahutamine</title>
...
<body class="container py-5">
    ...
    <?php if ($show_result): ?>
        <div class="alert alert-info animated-alert text-center fs-5">
            Oled õigesti lahendanud <?= $score ?> ülesannet <?= count($tasks) ?>st!
    ...
    <div class="text-center mt-4">
        <a href="../theory/index.php" class="btn btn-outline-secondary">← Tagasi teemadesse</a>
    </div>
</body>
</html>
