...
$tasks = [
    [
        'question' => 'Mis on tõenäosus saada täringuviskel paarisarv?',
        'options' => ['1/6', '1/3', '1/2', '2/3'],
        'answer' => '1/2'
    ],
    [
        'question' => 'Karbis on 3 punast ja 5 sinist palli. Mis on tõenäosus, et juhuslikult tõmmatud pall on punane?',
        'options' => ['3/5', '5/8', '3/8', '1/3'],
        'answer' => '3/8'
    ],
    [
        'question' => 'Mis on tõenäosus saada mündiviskel kull?',
        'options' => ['0%', '25%', '50%', '100%'],
        'answer' => '50%'
    ],
    [
        'question' => '36 kaardiga pakis. Mis on tõenäosus tõmmata emand?',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($score === count($tasks)) {
        // Kontrollime, kas kasutaja on selle teema juba läbinud
        ...
        if ($already_completed == 0) {
            // Lisame teema läbimise (trigger annab automaatselt 50 münti)
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Tõenäosuse alused</title>
...
<body class="container py-5">
    <h1 class="mb-4 text-center">🎲 Tõenäosuse alused</h1>
