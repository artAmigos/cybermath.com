...
$tasks = [
    [
        'question' => 'Arv √2 on...?',
        'options' => ['Looduslik', 'Täisarv', 'Ratsionaalne', 'Irratsionaalne'],
        'answer' => 'Irratsionaalne'
    ],
    [
        'question' => 'Arv -3 on...?',
        'options' => ['Looduslik', 'Irratsionaalne', 'Täisarv', 'Ükski neist'],
        'answer' => 'Täisarv'
    ],
    [
        'question' => '0,5 on...?',
        'options' => ['Ratsionaalne arv', 'Looduslik arv', 'Täisarv', 'Irratsionaalne arv'],
        'answer' => 'Ratsionaalne arv'
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Arvude tüübid</title>
            ...
            <div class="mb-4 p-4 task-card">
                ...
                <?php if ($show_result): ?>
                    <?php if (!isset($user_answers[$index])): ?>
                        <div class="mt-2 text-warning">❌ Pole vastatud</div>
                    <?php elseif ($user_answers[$index] != $task['answer']): ?>
                        <div class="mt-2 text-danger">❌ Vale. Õige vastus: <strong><?= $task['answer'] ?></strong></div>
                    <?php else: ?>
