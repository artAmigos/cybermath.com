...
$tasks = [
    ['question' => '6 × 8 = ?', 'options' => [48, 54, 42, 46], 'answer' => 48],
    ['question' => '20 ÷ 4 = ?', 'options' => [4, 5, 6, 3], 'answer' => 5],
    ['question' => '7 × 3 = ?', 'options' => [21, 24, 18, 19], 'answer' => 21],
];
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Korrutamine ja jagamine</title>
    ...
    <?php if ($show_result): ?>
        <div class="alert alert-info animated-alert text-center fs-5">
            ...
            <?php elseif ($score === count($tasks)): ?>
                <br><em class="text-muted">(on juba varem tehtud)</em>
            <?php endif; ?>
        </div>
    <?php endif; ?>
            ...
            <div class="mb-4 p-4 task-card">
                ...
                <?php if ($show_result): ?>
                    <?php if (!isset($user_answers[$index])): ?>
                        <div class="mt-2 text-warning">❌ Ei ole vastust</div>
