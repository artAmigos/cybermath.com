...
$tasks = [
    [
        'question' => 'Täisnurkse kolmnurga kaatetite pikkused on 6 ja 8. Kui pikk on hüpotenuus?',
        'options' => [9, 10, 12, 14],
        'answer' => 10
    ],
    [
        'question' => 'Täisnurkse kolmnurga hüpotenuus on 13 ja üks kaatetitest on 5. Kui pikk on teine kaatet?',
        'options' => [8, 10, 12, 15],
        'answer' => 12
    ],
    [
        'question' => 'Kas kolmnurk, mille küljed on 7, 24 ja 25, võib olla täisnurkne?',
        'options' => ['Jah', 'Ei'],
        'answer' => 'Jah'
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Pythagorase teoreem</title>
