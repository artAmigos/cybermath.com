...
$tasks = [
    [
        'question' => 'Milline graafik vastab funktsioonile y = 2x + 3?',
        'options' => ['Parabool', 'Hüperbool', 'Sirge', 'Kuup-parabool'],
        'answer' => 'Sirge'
    ],
    [
        'question' => 'Milline graafik läbib punkti (0,0)?',
        'options' => ['y = x² + 1', 'y = 2x', 'y = 3/x', 'y = 2ˣ'],
        'answer' => 'y = 2x'
    ],
    [
        'question' => 'Kuidas nimetatakse funktsiooni y = x² graafikut?',
        'options' => ['Hüperbool', 'Sirge', 'Parabool', 'Eksponentsiaalne funktsioon'],
        'answer' => 'Parabool'
    ],
    [
        'question' => 'Kui kalde kordaja k funktsioonis y = kx + b on positiivne, siis graafik:',
        'options' => ['Tõuseb', 'Langeb', 'On paralleelne X-teljega', 'Läbib alguspunkti'],
        'answer' => 'Tõuseb'
    ],
    [
        'question' => 'Millisel graafikul on vertikaalne asümptoot?',
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Funktsioonide graafikud</title>
...
<body class="container py-5">
    ...
    <?php if ($show_result): ?>
        <div class="alert alert-info animated-alert text-center fs-5">
            Sa vastasid õigesti <?= $score ?> / <?= count($tasks) ?> küsimusele!
            ...
            <div class="task-card">
                ...
                <?php if ($index == 0): ?>
                    <div class="d-flex flex-wrap my-3">
                        <img src="/cybermath.com/assets/taskright.png" class="graph-img-small" alt="Sirge">
                        <img src="/cybermath.com/assets/parabola.png" class="graph-img-small" alt="Parabool">
                        <img src="/cybermath.com/assets/giperbola.png" class="graph-img-small" alt="Hüperbool">
                        <img src="/cybermath.com/assets/cube.png" class="graph-img-small" alt="Kuup-parabool">
                    </div>
                <?php endif; ?>
