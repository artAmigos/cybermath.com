...
$tasks = [
    [
        'question' => 'Millele on võrdne log₂16?',
        'options' => [2, 3, 4, 5],
        'answer' => 4
    ],
    [
        'question' => 'Arvutage: log₅5 + log₅25',
        'options' => [2, 3, 4, 5],
        'answer' => 3
    ],
    [
        'question' => 'Milline avaldis on võrdne log₃9-ga?',
        'options' => ['1', '2', '3', '9'],
        'answer' => '2'
    ],
    [
        'question' => 'Millele on võrdne ln(e⁵)?',
        'options' => ['1', 'e', '5', 'e⁵'],
        'answer' => '5'
    ],
    [
        'question' => 'Lihtsusta avaldist: log₃27 - log₃3',
        'options' => ['1', '2', '3', '9'],
        'answer' => '2'
    ],
    [
        'question' => 'Kui logₓ16 = 2, siis millele on x võrdne?',
        'options' => [2, 4, 8, 16],
        'answer' => 4
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Logaritmid</title>
