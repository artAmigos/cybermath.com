...
$tasks = [
    [
        'question' => 'Millis neljandikus asub punkt (3, -2)?',
        'options' => ['I', 'II', 'III', 'IV'],
        'answer' => 'IV'
    ],
    [
        'question' => 'Mis on punkti (4, 5) sümmeetrilise punkti koordinaadid X-telje suhtes?',
        'options' => ['(4, -5)', '(-4, 5)', '(-4, -5)', '(5, 4)'],
        'answer' => '(4, -5)'
    ],
    [
        'question' => 'Kui pikk on vahemaa punktide (1, 2) ja (4, 6) vahel?',
        'options' => [3, 4, 5, 6],
        'answer' => 5
    ],
    [
        'question' => 'Milline punkt asub Y-teljel?',
        'options' => ['(0, 3)', '(2, 0)', '(1, 1)', '(0, 0)'],
        'answer' => '(0, 3)'
    ],
    [
        'question' => 'Kui punkt asub II neljandikus, siis millised on tema koordinaatide märgid?',
        'options' => ['(+, +)', '(-, +)', '(-, -)', '(+, -)'],
        'answer' => '(-, +)'
    ],
    [
        'question' => 'Kus asub koordinaatide alguspunkt?',
        'options' => ['Tasandi keskel', 'I neljandikus', 'X- ja Y-telje ristumiskohas', '1 ja 3 on õiged'],
        'answer' => '1 ja 3 on õiged'
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Koordinaattasand</title>
...
<body class="container py-5">
    <h1 class="mb-4 text-center">🧠 Koordinaattasand</h1>
