...
$tasks = [
    [
        'question' => 'Lahenda võrratus: \( 3x - 5 > 4 \)',
        'options' => ['x > 3', 'x < 3', 'x > -3', 'x < -3'],
        'answer' => 'x > 3'
    ],
    [
        'question' => 'Milline võrratus vastab vahemikule \( (-\infty; -2] \)?',
        'options' => ['x ≤ -2', 'x ≥ -2', 'x < -2', 'x > -2'],
        'answer' => 'x ≤ -2'
    ],
    [
        'question' => 'Lahenda võrratus: \( -2x + 4 ≥ 8 \)',
        'options' => ['x ≤ -2', 'x ≥ -2', 'x ≤ 2', 'x ≥ 2'],
        'answer' => 'x ≤ -2'
    ],
    [
        'question' => 'Millisel järgmistest võrratustest puudub lahend?',
        'options' => ['x² + 1 > 0', 'x² < -4', '3x - 5 < 10', 'x + 2 ≥ x - 1'],
        'answer' => 'x² < -4'
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Võrratused</title>
...
<body class="container py-5">
    <h1 class="mb-4 text-center">≠ Võrratused</h1>
