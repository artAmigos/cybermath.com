...
$tasks = [
    [
        'question' => 'Mis number tuleb järgmine aritmeetilises jadas: 7, 10, 13, ...?',
        'options' => [15, 16, 17, 18],
        'answer' => 16
    ],
    [
        'question' => 'Leia 5. liige geomeetrilises jadas, kui b₁=3 ja q=2',
        'options' => [24, 36, 48, 96],
        'answer' => 48
    ],
    [
        'question' => 'Kui suur on esimeste 4 liige summa aritmeetilises jadas: 5, 8, 11, 14?',
        'options' => [36, 38, 40, 42],
        'answer' => 38
    ],
    [
        'question' => 'Milline järgmistest on geomeetriline jada?',
        'options' => ['2,4,6,8', '3,6,12,24', '5,10,15,20', '1,3,5,7'],
        'answer' => '3,6,12,24'
    ],
    [
        'question' => 'Leia aritmeetilise jada erinevus, kui a₁=10, a₅=22',
        'options' => [2, 3, 4, 5],
        'answer' => 3
    ]
];
...
<body class="container py-5">
    <h1 class="mb-4 text-center">🧠 Aritmeetilised ja geomeetrilised jadad</h1>

    <?php if ($show_result): ?>
        <div class="alert alert-info animated-alert text-center fs-5">
            Lahendasite õigesti <?= $score ?> ülesannet <?= count($tasks) ?>-st!
