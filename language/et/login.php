...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        if ($user['status'] === 'blocked') {
            $error = "Teie konto on administraatori poolt blokeeritud.";
        } else {
            session_start();
        ...
        $error = "Vale e-post/logi nimi või parool.";
    }
}
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>CyberMathi sisselogimine</title>
...
<body>
    ...
    <div class="login-box">
        <h1>Sisselogimine</h1>
        <p class="tagline">Sisene e-posti või kasutajanimega</p>
        ...
        <form method="POST">
            <div class="mb-3">
                <input type="text" name="email_or_username" class="form-control" placeholder="E-post või kasutajanimi" required>
            </div>
            <div class="mb-3">
        ...
        <div class="mt-3">
            Pole kontot? <a href="register.php">Registreeru</a>
        </div>
    </div>
</body>
</html>
