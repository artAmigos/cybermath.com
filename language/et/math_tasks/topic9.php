...
$tasks = [
    1 => [
        'question' => "Lahenda võrrand: 2x + 3 = 11",
        'answer' => "4"
    ],
    2 => [
        'question' => "Lahenda võrrand: 5x - 7 = 18",
        'answer' => "5"
    ],
    3 => [
        'question' => "Lahenda võrrand: 3x + 2 = 17",
        'answer' => "5"
    ],
    4 => [
        'question' => "Lahenda võrrand: x/2 + 4 = 10",
        'answer' => "12"
    ],
    5 => [
        'question' => "Lahenda võrrand: 4x - 3 = 5",
        'answer' => "2"
    ],
    6 => [
        'question' => "Lahenda võrrand: 7x + 1 = 22",
        'answer' => "3"
    ],
    7 => [
        'question' => "Lahenda võrrand: x - 9 = 0",
        'answer' => "9"
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Kuid sa oled selle ülesande juba lahendanud, münte ei lisandu.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Lineaarvõrrandid - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧮 Lineaarvõrrandid</h1>
