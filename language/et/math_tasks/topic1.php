...
$tasks = [
    1 => [
        'question' => "Pingil istus 4 kassipoega. 2 kassipoega jooksid ära ja veel 3 kassipoega istusid pingile. Kui palju kassipoegi istub nüüd pingil?",
        'answer' => "5"
    ],
    2 => [
        'question' => "Korbis oli 5 õuna. Lisati veel 3 õuna ja siis söödi 2 õuna ära. Kui palju õunu jäi alles?",
        'answer' => "6"
    ],
    3 => [
        'question' => "Maal oli 10 kommi. Ta andis 4 kommi sõbrale ja sõi 1 kommi ära. Kui palju komme jäi talle?",
        'answer' => "5"
    ],
    4 => [
        'question' => "Bussis oli 7 reisijat. Peatuses astus sisse 5 inimest ja 3 väljus. Kui palju reisijaid on bussis nüüd?",
        'answer' => "9"
    ],
    5 => [
        'question' => "Liuskus ujuma 8 parte. 3 parte lendasid ära ja 2 uut lendasid kohale. Kui palju parte jäi liuskusse?",
        'answer' => "7"
    ],
    6 => [
        'question' => "Puu otsas istus 6 varblased. Lendasid veel 4 varblased ja siis lendasid ära 5. Kui palju varblasi jäi alles?",
        'answer' => "5"
    ],
    7 => [
        'question' => "Poes oli 15 telefoni. Müüdi 7 telefoni ja seejärel toodi veel 10 telefoni. Kui palju telefone on nüüd?",
        'answer' => "18"
    ],
    8 => [
        'question' => "Petel oli 20 eurot. Ta kulutas 12 eurot ja siis leidis veel 5 eurot. Kui palju raha tal on nüüd?",
        'answer' => "13"
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Kuid olete juba selle ülesande lahendanud, mündid ei lisandu.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Liitmine ja lahutamine - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧩 Liitmine ja lahutamine</h1>
    ...
    <div class="task-container">
        ...
        <form method="post">
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-primary btn-lg px-5">Kontrollige</button>
            </div>
        </form>
    </div>
