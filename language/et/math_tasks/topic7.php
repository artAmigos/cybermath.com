...
$tasks = [
    ...
    2 => [
        'question' => "Arvutage: √49",
        'answer' => "7"
    ],
    3 => [
        'question' => "Mis on (3^2) + (4^2)?",
        'answer' => "25"
    ],
    4 => [
        'question' => "Leidke 121 ruutjuur.",
        'answer' => "11"
    ],
    5 => [
        'question' => "Kui palju on 5^0?",
        'answer' => "1"
    ],
    6 => [
        'question' => "Leia avaldise väärtus: √(81) + 2^4",
        'answer' => "25"
    ],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Teenite {$reward} münti.";
        } else {
            $_SESSION['success_message'] = "Õige! Kuid te olete selle ülesande juba lahendanud, münte ei kogune.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Astmed ja juured - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📘 Astmed ja juured</h1>
