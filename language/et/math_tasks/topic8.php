...
$tasks = [
    1 => [
        'question' => "Arvutage: log₂(8)",
        'answer' => "3"
    ],
    2 => [
        'question' => "Arvutage: log₁₀(1000)",
        'answer' => "3"
    ],
    3 => [
        'question' => "Arvutage: log₃(27)",
        'answer' => "3"
    ],
    4 => [
        'question' => "Leidke avaldise väärtus: log₅(125)",
        'answer' => "3"
    ],
    5 => [
        'question' => "Lahendage võrrand: log₄(x) = 2",
        'answer' => "16"
    ],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Aga olete juba selle ülesande lahendanud, münte ei antud.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Logaritmid - CyberMath</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body { background: linear-gradient(135deg, #f5f7fa, #dbe9f4); }
        .task-container {
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📘 Logaritmid</h1>
