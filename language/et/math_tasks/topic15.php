...
$tasks = [
    1 => [
        'question' => "Leia nurga 30° siinus.",
        'answer' => "0.5"
    ],
    2 => [
        'question' => "Leia nurga 45° kosinus.",
        'answer' => "0.7071"
    ],
    3 => [
        'question' => "Leia nurga 60° tangens.",
        'answer' => "1.7321"
    ],
    4 => [
        'question' => "Leia nurga 90° kotangens.",
        'answer' => "0"
    ],
    5 => [
        'question' => "Leia nurga 90° siinus.",
        'answer' => "1"
    ],
    6 => [
        'question' => "Leia nurga 0° kosinus.",
        'answer' => "1"
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Olete teeninud {$reward} münte.";
        } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Trigonomeetria alused - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧩 Trigonomeetria alused</h1>
...
<div class="task-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <span class="reward-badge">+<?= TASK_REWARD ?> münte</span>
    </div>
