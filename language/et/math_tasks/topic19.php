...
$tasks = [
    1 => [
        'question' => "Arvutage ristküliku pindala, kui selle pikkus on 12 cm ja laius 5 cm.",
        'answer' => "60"
    ],
    2 => [
        'question' => "Leidke ruudu perimeeter, kui selle külg on 8 cm.",
        'answer' => "32"
    ],
    3 => [
        'question' => "Ringi pindala raadiusega 7 cm.",
        'answer' => "153.94"
    ],
    4 => [
        'question' => "Õigekeerilise kolmnurga perimeeter, kui selle kateteks on 6 cm ja 8 cm.",
        'answer' => "24"
    ],
    5 => [
        'question' => "Arvutage kolmnurga pindala, mille aluseks on 10 cm ja kõrguseks 4 cm.",
        'answer' => "20"
    ],
    6 => [
        'question' => "Ristküliku perimeeter, mille pikkus on 15 cm ja laius 10 cm.",
        'answer' => "50"
    ],
    7 => [
        'question' => "Pindala paralleelogrammiga, mille aluseks on 9 cm ja kõrguseks 6 cm.",
        'answer' => "54"
    ],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Kuid olete juba seda ülesannet lahendanud, mündid ei teenitud.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Pindala ja perimeeter - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧩 Pindala ja perimeeter</h1>
