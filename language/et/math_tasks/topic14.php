...
$tasks = [
    1 => [
        'question' => "Konstruktsiooni joonistamine funktsioonile: y = x^2 + 2x + 1",
        'answer' => "Graafik - parabool, tipuga punktis (-1, 0)"
    ],
    2 => [
        'question' => "Konstruktsiooni joonistamine funktsioonile: y = sin(x)",
        'answer' => "Graafik - sinusoida"
    ],
    3 => [
        'question' => "Konstruktsiooni joonistamine funktsioonile: y = cos(x)",
        'answer' => "Graafik - kosinusoida"
    ],
    4 => [
        'question' => "Konstruktsiooni joonistamine funktsioonile: y = |x|",
        'answer' => "Graafik - V-kujuline joon"
    ],
    5 => [
        'question' => "Konstruktsiooni joonistamine funktsioonile: y = e^x",
        'answer' => "Graafik - eksponentsiaalne"
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Kuid olete selle ülesande juba lahendanud, münte ei lisatud.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Funktsioonide graafikud - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📊 Funktsioonide graafikud</h1>
        <a href="index.php" class="btn btn-outline-secondary">← Tagasi teemadele</a>
    </div>
