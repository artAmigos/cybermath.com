...
$tasks = [
    1 => [
        'question' => "Muutuja on konteiner andmete salvestamiseks. Kuidas nimetatakse andmetüüpi, mis suudab hoida ainult ühte kahest väärtusest?",
        'answer' => "loogiline"
    ],
    2 => [
        'question' => "Mis on funktsioon programmeerimises?",
        'answer' => "koodilõik, mis täidab kindlat ülesannet"
    ],
    3 => [
        'question' => "Milline järgmistest muutujatest on numbriline muutuja? int, str, bool",
        'answer' => "int"
    ],
    4 => [
        'question' => "Milline on järgmise koodi täideviimise tulemus: x = 5, x = x + 3?",
        'answer' => "8"
    ],
    5 => [
        'question' => "Mis juhtub, kui muutuja kuulutatakse välja, kuid sellele ei ole väärtust määratud?",
        'answer' => "muutuja sisaldab vaikimisi väärtust"
    ],
    6 => [
        'question' => "Mis on funktsiooni argument?",
        'answer' => "väärtus, mis antakse funktsioonile selle kutsumisel"
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige vastus! Teenisite {$reward} münti.";
        } else {
            $_SESSION['success_message'] = "Õige vastus! Kuid olete juba selle ülesande lahendanud, münte ei antud.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Muutujad ja funktsioonid - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧩 Muutuja ja funktsioon</h1>
