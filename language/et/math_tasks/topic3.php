...
$tasks = [
    1 => [
        'question' => "Milline arv on naturaalarv: -5, 0, 3.5, 7?",
        'answer' => "7"
    ],
    2 => [
        'question' => "Märgi täisarv nimekirjast: 1/2, -3, √2, π",
        'answer' => "-3"
    ],
    3 => [
        'question' => "Milline arv on ratsionaalne: √9, π, √2, e?",
        'answer' => "√9"
    ],
    4 => [
        'question' => "Milline arv on irratsionaalne: 0.75, -4, √5, 1/3?",
        'answer' => "√5"
    ],
    5 => [
        'question' => "Kui palju täisarve on vahemikus -2.5 ja 3.5?",
        'answer' => "6"
    ],
    6 => [
        'question' => "Milline arv ei ole reaalarv: √-1, 0.333..., -5, 4/2?",
        'answer' => "√-1"
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Arvud - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🔢 Naturaalarvud, täisarvud, ratsionaalsed ja irratsionaalsed arvud</h1>
