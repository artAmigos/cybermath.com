...
$tasks = [
    1 => [
        'question' => "Kuidas nimetatakse kolmnurka, mille kõik küljed on võrdsed?",
        'answer' => "Võrdkülgne"
    ],
    2 => [
        'question' => "Kui palju nurki on ristkülikul?",
        'answer' => "4"
    ],
    3 => [
        'question' => "Kuidas nimetatakse viieküljalist hulknurka?",
        'answer' => "Viiekülik"
    ],
    4 => [
        'question' => "Milline kuju on, millel kõik küljed on sama pikkusega ja nurkad 90°?",
        'answer' => "Ruut"
    ],
    5 => [
        'question' => "Kuidas nimetatakse kuju, millel on 6 külge?",
        'answer' => "Kuuekülgne"
    ],
    6 => [
        'question' => "Kui palju nurki on ringil?",
        'answer' => "0"
    ],
    7 => [
        'question' => "Milline kuju on sirgetest jooned, mille kõik nurgad on 180°?",
        'answer' => "Kolmnurk"
    ],
    8 => [
        'question' => "Milline kuju on, millel on kaks vastastikku sirget nurka?",
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Kuid sa oled juba selle ülesande lahendanud, münte ei lisatud.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Geomeetrilised kujundid - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📐 Geomeetrilised kujundid</h1>
