...
$topic_id = 17;  // Teema "Pythagorase teoreem"

$tasks = [
    1 => [
        'question' => "Leia täisnurkse kolmnurga hüpotenuus, kui kaatetid on 3 ja 4.",
        'answer' => "5"
    ],
    2 => [
        'question' => "Täisnurkse kolmnurga hüpotenuus on 13, üks kaatetitest on 5. Leia teine kaatet.",
        'answer' => "12"
    ],
    3 => [
        'question' => "Täisnurkses kolmnurgas on üks kaatet 8 ja hüpotenuus 10. Leia teine kaatet.",
        'answer' => "6"
    ],
    4 => [
        'question' => "Leia täisnurkse kolmnurga hüpotenuus, kui kaatetid on 9 ja 12.",
        'answer' => "15"
    ],
    5 => [
        'question' => "Täisnurkses kolmnurgas on üks kaatet 7 ja hüpotenuus 25. Leia teine kaatet.",
        'answer' => "24"
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Kuid sa oled selle ülesande juba lahendanud, münte ei lisandunud.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Pythagorase teoreem - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧩 Pythagorase teoreem</h1>
