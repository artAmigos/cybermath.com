...
$tasks = [
    ...
    2 => [
        'question' => "Lahenda võrrand: x² + 4x + 4 = 0",
        'answer' => "-2"
    ],
    3 => [
        'question' => "Leia võrrandi diskriminant: x² - 2x + 1 = 0",
        'answer' => "0"
    ],
    4 => [
        'question' => "Lahenda võrrand: x² - x - 6 = 0",
        'answer' => "-2 ja 3"
    ],
    5 => [
        'question' => "Lahenda võrrand: x² + x - 12 = 0",
        'answer' => "-4 ja 3"
    ],
    6 => [
        'question' => "Leia võrrandi diskriminant: 2x² + 3x + 5 = 0",
        'answer' => "-31"
    ]
];
...
<head>
    <meta charset="UTF-8">
    <title>Ruutvõrrandid ja diskriminant - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">🧠 Ruutvõrrandid ja diskriminant</h1>
