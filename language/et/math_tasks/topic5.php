...
$tasks = [
    1 => [
        'question' => "Toote hind on 20% soodsam. Kui algne hind on 1000 rubla, siis kui palju maksab toode soodustusega?",
        'answer' => "800"
    ],
    2 => [
        'question' => "Õpilane lahendas õigesti 75% 20 ülesandest. Kui palju ülesandeid ta lahendas õigesti?",
        'answer' => "15"
    ],
    3 => [
        'question' => "Klassis on 40 õpilast. 25% neist on tublid õpilased. Kui palju on klassis tublisid õpilasi?",
        'answer' => "10"
    ],
    4 => [
        'question' => "Raamat maksis 1200 rubla, kuid tõusis 10%. Kui palju see nüüd maksab?",
        'answer' => "1320"
    ],
    5 => [
        'question' => "Toote hind on langetatud 15%. Kui uus hind on 1700 rubla, siis kui palju oli algne hind?",
        'answer' => "2000"
    ],
    6 => [
        'question' => "Poiss jooksis 60% 3 km distantsist. Kui palju kilomeetreid ta jooksis?",
        'answer' => "1.8"
    ],
    7 => [
        'question' => "Eksamil sai õpilane 50-st võimalikust punktist 90%. Kui palju punkte ta sai?",
        'answer' => "45"
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($is_correct) {
        if (!$already_solved) {
            ...
            $_SESSION['success_message'] = "Õige! Kuid sa oled juba selle ülesande lahendanud, mündid ei lisandunud.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Ülesanded: Protsendid - CyberMath</title>
...
<body class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary">📊 Protsendid</h1>
    ...
    <div class="task-nav">
        <div><span class="task-number">Ülesanne <?= $current_task ?> kokku <?= count($tasks) ?></span></div>
        <div>
